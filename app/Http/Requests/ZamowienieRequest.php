...
class ZamowienieRequest extends FormRequest
{
    ...
    private static $rules = [
        ...
        self::METHOD_POST => [
            ...
            'contractor_id' => 'required|integer|exists:kontrahents,id',
            'dimensions_id' => 'required|integer|exists:lexicons,code_id,type,dimensions',
            'width' => 'required|gt:0|integer',
            'height' => 'required|gt:0|integer',
            'thickness' => 'required|gt:0|integer',
            'typeOfGlass_id' => 'required|integer|exists:lexicons,code_id,type,typeOfGlass',
            'nameOfGlass_id' => 'required|integer|exists:lexicons,code_id,type,nameOfGlass',
            'treatment' => 'required|string|min:3',
            'quantity' => 'required|gt:0|integer',
            'amount' => 'required|gt:0|numeric|regex:/^\d*(\.\d{2})?$/',
            'numberDepartment_id' => 'required|integer|exists:lexicons,code_id,type,numberDepartment',
    ...
    public function messages()
    {
        return [
            ...
            'dimensions_id.exists' => 'Wymiar o takim ID nie istnieje',
            ...
            'typeOfGlass_id.exists' => 'Szkło o takim ID nie istnieje',
            ...
            'nameOfGlass_id.exists' => 'Nazwa szkła o takim ID nie istnieje',
            ...
            'numberDepartment_id.exists' => 'Dział o takim ID nie istnieje',
